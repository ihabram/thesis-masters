    ...
    def draw_content(self):
        ...
        for i, field in enumerate(fields):
            ...
            if field == 'Address_field':
                ...
                y += self.increment
                self.labels.append(text_label(self.draw, (x, y), 'Internet:', self.font, 'lm', 'Other'))
                width = self.get_textwidth('Internet: ')
                ...
                self.labels.append(text_label(self.draw, (x+width, y), self.data['S_BIC'], self.font, 'lm', 'Other'))

            elif field == 'Personal_field':
                self.labels.append(text_label(self.draw, (x, y), 'Kontakt:', self.font, 'lm', 'Other'))
                width = self.get_textwidth('Kontakt: ')
                ...
                self.labels.append(text_label(self.draw, (x+width, y), self.data['S_VAT'], self.font, 'lm', 'Other'))
