...
class DrawDateField():
    ...
    def draw_date_field(self, x, y):
        ...
        for entity in entities:
            if entity == 'I_Number':
                self.labels.append(text_label(self.draw, (x, y), 'Belegnummer:', self.font, 'lm', 'Other'))
                self.labels.append(text_label(self.draw, (x+width, y), self.data[entity], self.font, 'lm', entity))
            elif entity == 'Start_Date':
                self.labels.append(text_label(self.draw, (x, y), 'Zeitraum:', self.font, 'lm', 'Other'))
                self.labels.append(text_label(self.draw, (x+width, y), self.data[entity], self.font, 'lm', 'Other'))
                ...
                self.labels.append(text_label(self.draw, (x, y), 'Rechnungsdatum:', self.font, 'lm', 'I_Date'))
                self.labels.append(text_label(self.draw, (x+width, y), self.data[entity], self.font, 'lm', entity))
            y += self.increment
    ...
    def draw_contact_field(self, x, y):
        ...
        self.labels.append(text_label(self.draw, (x, y), 'Bei Rückfragen:', self.font, 'lm', 'Other'))
        self.labels.append(text_label(self.draw, (x+width, y), self.data['S_Tel'], self.font, 'lm', 'Other'))
        y += self.increment
        self.labels.append(text_label(self.draw, (x+width, y), self.data['S_Email'], self.font, 'lm', 'Other'))
        y += self.increment
